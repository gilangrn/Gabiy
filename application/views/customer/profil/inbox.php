        ...
        <div class="email-app-sidebar-content">
            <div class="email-app-menu">
                ...
                <div class="list-group list-group-messages">
                    <a class="list-group-item active no-border">
                        ...
                        <div class="list-group">
                            <div class="users-list-padding">
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <span class="media-object rounded-circle text-circle d-flex mr-2 justify-content-center align-items-center bg-info">T</span>
                                        </span>
                                        <div class="media-body">
                                            ...
                                            <p class="list-group-item-text text-truncate text-bold-500">PixInvent, I fount you...</p>
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <span class="media-object rounded-circle text-circle d-flex mr-2 justify-content-center align-items-center bg-danger">L</span>
                                        </span>
                                        <div class="media-body">
                                            ...
                                            <p class="list-group-item-text text-truncate text-bold-500">Thanks, Let's do it.</p>
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <span class="media-object rounded-circle text-circle d-flex mr-2 justify-content-center align-items-center bg-warning">E</span>
                                        </span>
                                        <div class="media-body">
                                            ...
                                            <p class="list-group-item-text text-truncate text-bold-500">You have new comment...</p>
                                ...
                                <a class="list-group-item list-group-item-action bg-blue-grey bg-lighten-5 border-right-primary border-right-2">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <img class="media-object rounded-circle" src="app-assets/img/portrait/small/avatar-s-7.png" alt="Generic placeholder image">
                                        </span>
                                        <div class="media-body">
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <img class="media-object rounded-circle" src="app-assets/img/portrait/small/avatar-s-5.png" alt="Generic placeholder image">
                                        </span>
                                        <div class="media-body">
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <span class="media-object rounded-circle text-circle d-flex mr-2 justify-content-center align-items-center bg-success">H</span>
                                        </span>
                                        <div class="media-body">
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <img class="media-object rounded-circle" src="app-assets/img/portrait/small/avatar-s-8.png" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                        <div class="media-body">
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <span class="media-object rounded-circle text-circle d-flex mr-2 justify-content-center align-items-center bg-warning">V</span>
                                        </span>
                                        <div class="media-body">
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <span class="media-object rounded-circle text-circle d-flex mr-2 justify-content-center align-items-center bg-info">E</span>
                                        </span>
                                        <div class="media-body">
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <img class="media-object rounded-circle" src="app-assets/img/portrait/small/avatar-s-6.png" alt="Generic placeholder image">
                                        </span>
                                        <div class="media-body">
                                            <h6 class="list-group-item-heading">Sarah Montgomery
                                                <span class="font-small-2 float-right">Yesterday</span>
                                ...
                                <a class="list-group-item list-group-item-action no-border">
                                    <span class="media">
                                        <span class="avatar avatar-md mr-2">
                                            <img class="media-object rounded-circle" src="app-assets/img/portrait/small/avatar-s-10.png" alt="Generic placeholder image">
                                            <i></i>
                                        </span>
                                        <div class="media-body">
                                            <h6 class="list-group-item-heading">Kelly Reyes
                ...
                <div class="email-app-mail-content-detail">
                    ...
                    <div class="media-list">
                        <div id="headingCollapse1" class="card-header p-0">
                            <a data-toggle="collapse" href="#collapse1" aria-expanded="true" aria-controls="collapse1" class="collapsed email-app-sender list-group-item list-group-item-action no-border bg-blue-grey bg-lighten-5">

                                <span class="media">
                                    <span class="avatar avatar-md mr-2">
                                        <img class="media-object rounded-circle width-50" src="app-assets/img/portrait/small/avatar-s-1.png" alt="Generic placeholder image">
                                    </span>
                                    <div class="media-body">
                        ...
                        <div id="collapse1" role="tabpanel" aria-labelledby="headingCollapse1" class="card-collapse collapse" aria-expanded="true">
                            <div class="card-body">
                                <div class="card-block">
                                    ...
                                    <p>Gmail Material Design Concept. Please check the full project on Behance. Hope that will be
                                        fine for you.</p>
                        ...
                        <div id="headingCollapse2" class="card-header p-0">
                            <a data-toggle="collapse" href="#collapse2" aria-expanded="false" aria-controls="collapse2" class="email-app-sender list-group-item list-group-item-action no-border">

                                <div class="media">
                                    <span class="avatar avatar-md mr-2">
                                        <img class="media-object rounded-circle width-50" src="app-assets/img/portrait/small/avatar-s-7.png" alt="Generic placeholder image">
                                    </span>
                                    <div class="media-body">
                            ...
                            <div class="card-body">
                                <div class="email-app-text card-block">
                                    <div class="email-app-message">
                                        <p>Hi John,</p>
                                        <p>Thanks for your feedback ! Here's a new layout for a new Apex Admin theme.</p>
                                        <p>We will start the new application development soon once this will be completed, I will provide
