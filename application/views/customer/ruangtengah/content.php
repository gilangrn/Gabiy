        ...
        <div class="container-fluid">
          ...
          <div class="navbar-container">
            <div id="navbarSupportedContent" class=" navbar-collapse">
              <ul class="navbar-nav">
                <li class="nav-item mr-1 mt-1"><h4>Hello, <?php echo $username; ?>!</h4></li>
