								...
								<div class="card-body">
									<table class="table table-responsive-sm text-center">
										...
										<tbody>
											<tr>
												<td>
													<img class="media-object round-media height-50" src="assets/img/elements/01.png" alt="Generic placeholder image"
													/>
												</td>
											...
											<tr>
												<td>
													<img class="media-object round-media height-50" src="assets/img/elements/07.png" alt="Generic placeholder image"
													/>
												</td>
												<td>Headphones</td>
												<td>2</td>
											...
											<tr>
												<td>
													<img class="media-object round-media height-50" src="assets/img/elements/11.png" alt="Generic placeholder image"
													/>
												</td>
												<td>Camera</td>
												<td>1</td>
											...
											<tr>
												<td>
													<img class="media-object round-media height-50" src="assets/img/elements/14.png" alt="Generic placeholder image"
													/>
												</td>
												<td>Beer</td>
												<td>2</td>
									...
									<div class="card-block">
										<div class="chart-info mb-2">
											...
											<span class="text-uppercase">
												<i class="fa fa-circle deep-purple font-small-2 mr-1"></i> Visits</span>
										</div>
								...
								<div class="card-body">
									<div class="card-block">
										...
										<div class="my-3 text-center white">
											<a class="font-large-2 d-block mb-1">$ 78.89
												<span class="ft-arrow-up font-large-2"></span>
											</a>
			...
			<footer class="footer footer-static footer-light">
				<p class="clearfix text-muted text-sm-center px-2">
					<span>Copyright &copy; 2018
						<a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" id="pixinventLink" target="_blank"
						class="text-bold-800 primary darken-2">PIXINVENT </a>, All rights reserved. </span>
				</p>
			</footer>
	...
	<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block">
		...
		<div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
			...
			<div class="cz-bg-image row">
				<div class="col mb-3">
					<img src="assets/img/sidebar-bg/01.jpg" width="90" class="rounded">
				</div>
				<div class="col mb-3">
					<img src="assets/img/sidebar-bg/02.jpg" width="90" class="rounded">
				</div>
				<div class="col mb-3">
					<img src="assets/img/sidebar-bg/03.jpg" width="90" class="rounded">
				</div>
				<div class="col mb-3">
					<img src="assets/img/sidebar-bg/04.jpg" width="90" class="rounded">
				</div>
				<div class="col mb-3">
					<img src="assets/img/sidebar-bg/05.jpg" width="90" class="rounded">
				</div>
				<div class="col mb-3">
					<img src="assets/img/sidebar-bg/06.jpg" width="90" class="rounded">
				</div>
			</div>
