          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="pull-right">
                <button type="button" class="mr-1 mb-1 btn btn-raised btn-outline-success btn-min-width" data-toggle="modal" data-target="#addUserModal">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content border-success" style="border-radius: 8px;">
                  <div class="modal-header bg-success">
                    <h3 class="modal-title white">Add User</h3>
